...
tmp<volScalarField> myKOmegaSSTBase<BasicEddyViscosityModel>::F1
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> myKOmegaSSTBase<BasicEddyViscosityModel>::F2() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> myKOmegaSSTBase<BasicEddyViscosityModel>::F3() const
{
...
template<class BasicEddyViscosityModel>
tmp<volScalarField> myKOmegaSSTBase<BasicEddyViscosityModel>::F23() const
{
...
template<class BasicEddyViscosityModel>
void myKOmegaSSTBase<BasicEddyViscosityModel>::correctNut
(
...
template<class BasicEddyViscosityModel>
Foam::tmp<Foam::volScalarField> myKOmegaSSTBase<BasicEddyViscosityModel>::S2
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> myKOmegaSSTBase<BasicEddyViscosityModel>::Pk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> myKOmegaSSTBase<BasicEddyViscosityModel>::epsilonByk
(
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> myKOmegaSSTBase<BasicEddyViscosityModel>::GbyNu0
(
    const volTensorField& gradU,
...
template<class BasicEddyViscosityModel>
tmp<volScalarField::Internal> myKOmegaSSTBase<BasicEddyViscosityModel>::GbyNu
(
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> myKOmegaSSTBase<BasicEddyViscosityModel>::kSource() const
{
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> myKOmegaSSTBase<BasicEddyViscosityModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>::New
    (
        omega_,
...
template<class BasicEddyViscosityModel>
tmp<fvScalarMatrix> myKOmegaSSTBase<BasicEddyViscosityModel>::Qsas
(
    const volScalarField::Internal& S2,
...
template<class BasicEddyViscosityModel>
myKOmegaSSTBase<BasicEddyViscosityModel>::myKOmegaSSTBase
(
    const word& type,
...
template<class BasicEddyViscosityModel>
void myKOmegaSSTBase<BasicEddyViscosityModel>::setDecayControl
(
...
template<class BasicEddyViscosityModel>
bool myKOmegaSSTBase<BasicEddyViscosityModel>::read()
{
...
template<class BasicEddyViscosityModel>
void myKOmegaSSTBase<BasicEddyViscosityModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
