...
void myKOmega<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicTurbulenceModel>
myKOmega<BasicTurbulenceModel>::myKOmega
(
...
template<class BasicTurbulenceModel>
bool myKOmega<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void myKOmega<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    }
    Info<<"\nmy custom k omega model is running\n"<<endl;
    // Local references
