...
:
    ...
    cassonModelCoeffs_(viscosityProperties.optionalSubDict(typeName + "Coeffs")),
    // k_("k", dimViscosity, cassonModelCoeffs_),
    // n_("n", dimless, cassonModelCoeffs_),
...
)
{
    ...
    cassonModelCoeffs_.readEntry("k", k_);
    cassonModelCoeffs_.readEntry("n", n_);
    cassonModelCoeffs_.readEntry("nuMin", nuMin_);
    cassonModelCoeffs_.readEntry("nuMax", nuMax_);
    cassonModelCoeffs_.readEntry("m", m_);
    cassonModelCoeffs_.readEntry("tau0", tau0_);
